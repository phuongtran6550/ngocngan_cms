...
**Tech Stack:** Vue 3 Options API, Vue Router, Pinia, Bootstrap 5, Phoenix v1.24.0 stylesheet, Sass, Vitest, Playwright.
...
- The current test suite asserts some of these custom selectors. Those tests must be replaced with Phoenix anatomy assertions, not preserved as proof of an incorrect implementation.
...
- Test: `tests/unit/AppComposition.test.ts`
...
- [ ] Run focused unit tests and the shell E2E test at desktop, tablet, and mobile widths.
...
- Test: `tests/unit/components/Table/ResourceViews.test.ts`
...
- [ ] Run focused tests, list-page E2E coverage, and responsive visual checks.
...
- Test: `tests/unit/views/Dashboard/pages/DashboardPage.test.ts`
- Test: `tests/e2e/core-pages.spec.ts`
...
- [ ] Run dashboard unit test and desktop/tablet/mobile E2E visual checks.
...
- Test: `tests/unit/components/FormLayout/index.test.ts`
- Test: `tests/unit/views/Orders/pages/OrderPages.test.ts`
- Test: `tests/unit/views/WarehousedGoods/pages/WarehouseDetailPage.test.ts`
...
- [ ] Run form/detail unit tests and interaction E2E checks.
...
- Modify: `src/styles/_components.scss`
- Test: `tests/unit/views/Account/pages/LoginPage.test.ts`
- Test: `tests/e2e/core-pages.spec.ts`
...
- Test: `tests/architecture/phoenix-page-anatomy.test.ts`
- Test: `tests/e2e/route-matrix.spec.ts`
- Test: `tests/e2e/responsive-matrix.spec.ts`
- Test: `tests/e2e/css-stability.spec.ts`

- [ ] Update architecture tests to reject the obsolete parallel visual system rather than asserting `cms-*` presentation classes.
...
- [ ] Run `npm run typecheck`, `npm run lint`, `npm run build`, `npm run test:unit`, and `npm run test:e2e`.
